...
import { Row, Col, Form, Modal, notification, Button, Table, Input, Radio, Space, Select } from "antd";
...
function Snapshot() {
	...
	const getData = () => {
		...
		WebSocketService.call(uuid, URL.SNAPSHOT_QUERY, [[["pool", "!=", "freenas-boot"], ["pool", "!=", "boot-pool"], ["name", "!^", "data/.system"]]]);
	}
	...
	return (
		<div className={'full-page'}>
			<Row className={'title'}>快照管理</Row>
			<Row className={'sub-title'}>查看，创建，删除和导出快照</Row>
			<Row className={'actions'}>
				<Button type={'primary'} onClick={()=>{navigate('/share/snapshot-manage/create')}}>创建手动快照</Button>
			</Row>
			{/*<Space.Compact style={{width: '300px', marginBottom: '10px'}}>*/}
			{/*	<Input size={'small'} placeholder={'请输入要搜索的快照的名称'}/>*/}
